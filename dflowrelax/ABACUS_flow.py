...
from dflowrelax.ABACUS_OPs import RelaxMakeABACUS, ABACUS, RelaxPostABACUS
...
def main_abacus():
    ...
    relaxmake = Step(
        name="Relaxmake",
        template=PythonOPTemplate(RelaxMakeABACUS, image=dpgen_image_name, command=["python3"]),
    ...
    abacus_cal = Step(
        name="ABACUS-Cal",
        template=abacus,
        artifacts={"input_abacus": relaxmake.outputs.artifacts["jobs"]},
